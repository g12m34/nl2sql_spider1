...
### V2 Results (After Initial Fix)

| Model | Stratified 100 | Hard/Extra 100 |
|-------|----------------|----------------|
| Gemini 3 Flash | **55.0%** (55/100) | **59.0%** (59/100) |
| Gemini 2.5 Pro | 46.0% (46/100) | 42.0% (42/100) |
| DeepSeek v3.2 | 41.0% (41/100) | 47.0% (47/100) |
...
1. **Semantic layer quality is critical**: A single redundant alias pattern caused 27% of questions to fail.

2. **Gemini 3 Flash outperforms Gemini 2.5 Pro on Malloy generation**: 55% vs 46% on stratified, 59% vs 42% on hard/extra.

3. **DeepSeek performs reasonably but behind Gemini 3 Flash**: 41-47% accuracy.

4. **Hard questions show similar patterns**: The geo database bug affected all models equally.

5. **Next Steps**:
   - Re-run evaluations with fully fixed geo.malloy
   - Investigate remaining compile errors in other databases
   - Consider adding more intermediate sources for complex join paths
